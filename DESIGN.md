...
```json
{
  "response": "今天天气晴朗，气温适宜，是个出门的好日子!",
  "history": [
    ["你好", "你好!有什么可以帮助你的吗?"],
    ["今天天气怎么样", "今天天气晴朗，气温适宜，是个出门的好日子!"]
  ]
}
```
...
```json
{
  "response": "好的!有一天，小明对小红说...",
  "history": [
    ["讲个笑话", "好的!有一天，小明对小红说..."]
  ],
  "audio_url": "/temp/audio_xxx.pcm"  // 如果play_audio=true
}
```
