...
class FlashGpt_neoxForCausalLM(FlashGPTNeoXPreTrainedModel):
    ...
    def init_ascend_operations(self, config):
        ...
        self.base_max_seq_len = 128
        self.ascend_atten_mask = AttentionMask.static(self.base_max_seq_len)
    ...
    def prepare_inputs_for_ascend(self, input_ids: torch.Tensor,
        ...
        if self.soc_info.need_nz:
            atten_mask = self.ascend_atten_mask.get_attn_mask(self.base_max_seq_len, self.dtype, self.device)
