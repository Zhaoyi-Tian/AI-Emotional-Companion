...
class FlashLlamaForCausalLM(FlashForCausalLM):
    ...
    def init_ascend_weight(self):
        ...
        tp_rank_table_file = ENV.tp_rank_table_file
        ...
        coder_param = {
            ...
            "tpRankTableFile": tp_rank_table_file,
    ...
    def prepare_inputs_for_ascend(
        ...
        if is_prefill:
            ...
            if self.enable_greedy_search_opt:
                self.acl_encoder_operation_inputs.append(self.logits_offset_tensor)
            ...
            if self.enable_greedy_search_opt:
                self.acl_decoder_operation_inputs.append(self.logits_offset_tensor)
