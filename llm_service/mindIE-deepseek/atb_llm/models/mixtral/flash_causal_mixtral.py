...
class FlashMixtralForCausalLM(FlashForCausalLM):
    ...
    def get_weights(self):
        ...
        for i in range(self.num_layers):
            ...
            if self.tp:
                ...
                msg = "ERROR: Mixtral does not support expert parallel!"
    ...
    def init_ascend_weight(self):
        ...
        coder_param = {
            ...
            "backend": self.soc_info.communication_backend
                     if not (self.mapping.has_dp() and self.mapping.has_attn_tp())
                     else "hccl",
    ...
    def prepare_inputs_for_ascend(self, input_ids: torch.Tensor,
        ...
        if is_prefill:
            ...
            if self.mapping.has_dp() and self.mapping.has_mlp_tp():
                self.acl_encoder_operation_inputs.insert(12, final_hidden_states)
                self.acl_encoder_operation_inputs.insert(13, shard_effective_token_indices)
                self.acl_encoder_operation_inputs.insert(14, token_index_with_padding)
                self.acl_encoder_operation_inputs.insert(15, skip_padding_token_indices)
            ...
            if self.mapping.has_dp() and self.mapping.has_mlp_tp():
                self.acl_decoder_operation_inputs.insert(12, final_hidden_states)
                self.acl_decoder_operation_inputs.insert(13, shard_effective_token_indices)
                self.acl_decoder_operation_inputs.insert(14, token_index_with_padding)
                self.acl_decoder_operation_inputs.insert(15, skip_padding_token_indices)
