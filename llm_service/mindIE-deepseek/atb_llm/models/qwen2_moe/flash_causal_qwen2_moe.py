...
class FlashQwen2moeForCausalLM(FlashForCausalLM):
    ...
    def init_ascend_weight(self):
        ...
        mlp_linear_transpose_types = [[1, -1, 0, -1] for _ in range(self.config.num_hidden_layers)]
        ...
        acl_param_dict = {
            ...
            "enableSwiGLU": False if self.soc_info.need_nz else True,  # 是否使用融合算子，对于910B系列已经支持
