...
from .flash_causal_vita import VitaConfig
from .modeling_vita_audio import AudioEncoderProcessor
from .tool import tokenizer_image_audio_token, tokenizer_image_token, get_rawvideo_dec, VideoConfig, dynamic_preprocess
...
class VitaRouter(BaseRouter):
    ...
    def get_config(self):
        ...
        if 'mixtral' in model_type:
            VitaConfig.model_type = "vita-mixtral"
        elif 'qwen' in model_type:
            VitaConfig.model_type = "vita-Qwen2"
        config = VitaConfig.from_pretrained(self.model_name_or_path)
