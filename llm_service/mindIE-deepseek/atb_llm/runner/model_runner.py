...
class ModelRunner:
    ...
    def __init__(self,
        ...
        self.mapping = Mapping(world_size=world_size, rank=rank, **kwargs)
    ...
    def load_weights(self, **kwargs):
        ...
        if not ENV.enable_refactor and self.lora_adapter is not None:
