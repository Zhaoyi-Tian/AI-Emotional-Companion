...
class EnvVar:
    ...
    tp_rank_table_file: str = os.getenv("TP_RANKTABLEFILE", "")

    enable_mc2 = os.getenv("ENABLE_MC2", "0") == "1" and os.getenv("ATB_LLM_HCCL_ENABLE", "0") == "1"
    enable_greedy_search_opt: bool = os.getenv("ENABLE_GREEDY_SEARCH_OPT", "0") == "1"
    enable_refactor: bool = os.getenv("REFACTOR_ENABLE", "0") == "1"
    ...
    def __post_init__(self):
        ...
        self.check_ranktable(self.tp_rank_table_file)
