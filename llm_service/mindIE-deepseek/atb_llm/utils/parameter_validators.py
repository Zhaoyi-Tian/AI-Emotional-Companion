    ...
    def validate(self, value: Any, key: Any = None) -> None:
        try:
            ...
            if key is not None:
                ...
                raise ValueError(f"Validation failed for argument") from e
...
class StringParameterValidator(ParameterValidator):
    def __init__(self, *fields: Field, allow_none: bool = False):
        super().__init__(str, *fields, allow_none=allow_none)
...
class DictionaryParameterValidator(ParameterValidator):
    ...
    def __init__(self, element_validator_mapping: Dict[Any, ParameterValidator], allow_none: bool = False):
