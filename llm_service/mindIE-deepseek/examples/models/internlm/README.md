...
| intenlm2.5-1.8B   | 支持world size 1   | 支持world size 1   | √    | ×   | ×               | √               | ×        | ×                | ×            | ×                          | ×    | ×      | ×    | ×    |
| intenlm2.5-7B   | 支持world size 1,2,4,8   | 支持world size 1,2,4,8   | √    | ×   | ×               | √               | ×        | ×                | ×            | ×                          | ×    | √      | ×    | √    |
| intenlm2.5-20B   | 支持world size 2,4,8   | 支持world size 2,4,8   | √    | ×   | ×               | √               | ×        | ×                | ×            | ×                          | ×    | ×      | ×    | ×    |
| intenlm3-8B   | 支持world size 1,2        | 支持world size 1,2     | √    | ×   | ×               | √               | ×        | ×                | ×            | ×                          | ×    | √      | ×    | ×    |
...
- [intenlm2.5-1.8B](https://huggingface.co/internlm/internlm2_5-1_8b-chat/tree/main)
- [intenlm2.5-7B](https://huggingface.co/internlm/internlm2_5-7b-chat/tree/main)
- [intenlm2.5-20B](https://huggingface.co/internlm/internlm2_5-20b-chat/tree/main)
- [intenlm3-8B](https://huggingface.co/internlm/internlm3-8b-chat/tree/main)
