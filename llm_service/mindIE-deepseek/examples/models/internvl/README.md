...
- 支持 InternVL1.0系列，InternVL1.5系列，InternVL2.0系列，以及InternVL2.5系列中的大部分开源模型，具体支持情况请参见[特性矩阵](#特性矩阵)部分。
...
| InternVL2-1B | 支持world size 1,2,4,8         | 支持world size 1,2,4,8          | √    | √    | √               | 文本、图片               | 文本、图片        |
...
| InternVL2-26B | 支持world size 4,8         | 支持world size 4,8          | √    | ×    | √               | 文本、图片               | 文本、图片        |
| InternVL2-40B | 支持world size 4,8         | 支持world size 4,8          | √    | √    | √               | 文本、图片               | 文本、图片        |
| InternVL2-Llama3-76B | 支持world size 8         | 支持world size 8          | √    | √    | √               | 文本、图片               | 文本、图片        |
| InternVL2.5-1B | 支持world size 1,2,4,8         | 支持world size 1,2,4,8          | √    | √    | √               | 文本、图片               | 文本、图片        |
| InternVL2.5-2B | 支持world size 1,2,4,8         | 支持world size 1,2,4,8          | √    | ×    | √               | 文本、图片               | 文本、图片        |
| InternVL2.5-4B | 支持world size 1,2,4,8         | 支持world size 1,2,4,8          | √    | √    | √               | 文本、图片               | 文本、图片        |
| InternVL2.5-8B | 支持world size 1,2,4,8         | 支持world size 1,2,4,8          | √    | ×    | √               | 文本、图片               | 文本、图片        |
| InternVL2.5-26B | 支持world size 4,8         | 支持world size 4,8          | √    | ×    | √               | 文本、图片               | 文本、图片        |
| InternVL2.5-38B | 支持world size 4,8         | 支持world size 4,8          | √    | √    | √               | 文本、图片               | 文本、图片        |
| InternVL2.5-78B | 支持world size 8         | 支持world size 8          | √    | √    | √               | 文本、图片               | 文本、图片        |
