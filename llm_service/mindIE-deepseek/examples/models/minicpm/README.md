...
- 环境变量说明
  - `export ASCEND_RT_VISIBLE_DEVICES=0,1,2,3,4,5,6,7`
    ...
    - 核心 ID 查阅方式见[此 README 文件](../../../../../../MindIE-LLM/examples/atb_models/examples/README.md)的【启动脚本相关环境变量】章节
...
- 参考[此 README 文件](../../../../../../MindIE-LLM/examples/atb_models/tests/modeltest/README.md)
  - 示例 
    ```shell
