...
| ----------------- |----------------------------|-----------------------------| ---- | ---- | --------------- | --------------- | -------- | --------- | ------------ | -------- | ------- | -------------- | --- | ------ | ---------- | --- | --- | --- |
| Qwen-7B           | 支持world size 1,2,4,8       | 支持world size 1              | √    | ×    | √               | √               | √        | ×         | ×            | ×        | ×       | √              | ×   | ×      | x       | x | x | x |
| Qwen-14B          | 支持world size 2,4,8         | 支持world size 1,2            | √    | ×    | √               | √               | √        | ×         | ×            | ×        | ×       | √              | ×   | ×      | x       | x | x | x |
| Qwen-72B          | 支持world size 8             | ×                           | √    | ×    | √               | √               | ×        | √         | ×            | ×        | ×       | √              | ×   | ×      | x       | x | x | x |
| Qwen1.5-0.5B      | 支持world size 1,2,4,8       | 支持world size 1              | √    | ×    | √               | √               | ×        | ×         | ×            | ×        | ×       | ×              | ×   | ×      | x       | x | x | x |
| Qwen1.5-1.8B      | 支持world size 1,2,4,8       | 支持world size 1              | √    | ×    | √               | √               | ×        | ×         | ×            | ×        | ×       | ×              | ×   | ×      | x       | x | x | x |
| Qwen1.5-4B        | 支持world size 1,2,4         | 支持world size 1              | √    | ×    | √               | √               | ×        | ×         | ×            | ×        | ×       | ×              | ×   | ×      | x       | x | x | x |
| Qwen1.5-7B        | 支持world size 1,2,4,8       | 支持world size 1              | √    | ×    | √               | √               | ×        | ×         | ×            | ×        | ×       | √              | ×   | ×      | x       | x | x | x |
...
| Qwen1.5-110B      | 支持world size 8             | ×                           | √    | ×    | √               | √               | ×        | √         | ×            | ×        | ×       | ×              | ×   | ×      | x       | x | x | x |
| Qwen1.5-MoE-A2.7B | 支持world size 4             | ×                           | √    | ×    | √               | √               | ×        | ×         | ×            | ×        | ×       | ×              | ×   | ×      | x       | x | x | x |
| Qwen2-57B-A14B    | 支持world size 8             | ×                           | ×    | √    | ×               | √               | ×        | ×         | ×            | ×        | ×       | √              | ×   | ×      | x       | x | x | x |
| Qwen2-0.5B        | 支持world size 1,2,4,8       | 支持world size 1,2,4,8        | √    | ×    | ×               | √               | ×        | ×         | ×            | ×        | x       | √              | ×   | ×      | x       | x | x | x |
| Qwen2-1.5B        | 支持world size 1,2,4,8       | 支持world size 1,2,4,8        | √    | ×    | ×               | √               | ×        | ×         | ×            | ×        | x       | √              | ×   | ×      | x       | x | x | x |
| Qwen2-7B          | 支持world size 1,2,4,8       | 支持world size 1,2,4,8        | √    | √    | ×               | √               | √        | ×         | ×            | √        | x       | √              | ×   | ×      | x       | x | x | x |
| Qwen2-72B         | 支持world size 1,2,4,8       | 支持world size 1,2,4,8        | √    | √    | ×               | √               | √        | √         | √            | √        | ×       | √              | ×   | √      | √       | x | √ | √ |
| gte-Qwen2-7B      | 支持world size 1,2,4         | ×                           | √    | ×    | ×               | √               | ×        | ×         | ×            | ×        | ×       | ×              | ×   | ×      | x       | x | x | x |
...
| QwenCode2.5-7B          | ×       | 支持world size 1,2,4,8        | √    | ×    | ×               | √               | ×        | ×         | ×            | √        | x       | √              | ×   | ×      | √       | x | x | x |
...
- 使用下列命令进行W8A8稀疏量化权重导出：
  ...
  - Step 2：切分及压缩权重
    ...
    ```
  - 与qwen2-72B W8A16量化不同，`convert_quant_weights_72b.py`脚本已经替用户按要求修改了config.json，用户只需要将config.json中的quant_type字段修改为"w8a8s"即可。
