...
|-------------|-------------------------|-------------------------|------|------|-----------------|-----------------|---------|---------|--------------|----------|--------|--------|-----|-----|
| WizardCoder-34B   | 支持world size 4,8   | 支持world size 4,8     | 是   | 否   | 否              | 是              | 否       | 否       | 否           | 否       | 否     | 否     | 否  | 否 |

# 使用说明

## 环境配置
- 建议使用transformers==4.44.0版本进行测试,
...
- 参考[此README文件](../../../tests/modeltest/README.md)
  - 示例
    ...
    export ASCEND_RT_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
    # 运行Paged Attention FP16
    bash run.sh pa_fp16 full_HumanEval_X 1 wizard ${weight_path} 8
    ```
