...
class ModelTest:
    def __init__(self, model_type, data_type, test_mode, model_name, output_dir, dataset_name, batch_size_lst,
                 ...
                 prefill_batch_size, dp, tp, moe_tp, moe_ep, pp, microbatch_size, trust_remote_code) -> None:
...
def parse_args():
    ...
    parser.add_argument("--parallel_params", type=str, default="[-1,-1,-1,-1,-1,-1]",
                        help="Specify parallelism, [dp,tp,moe_tp,moe_ep,pp,microbatch_size]")
...
def get_args():
    ...
    dp, tp, moe_tp, moe_ep, pp, microbatch_size = ast.literal_eval(args.parallel_params)
    ...
    return [args.model_type, args.data_type, args.test_mode, args.model_name, output_dir, args.dataset_name,
            ...
            args.kw_args, args.prefill_batch_size, dp, tp, moe_tp, moe_ep, pp, microbatch_size, trust_remote_code]
